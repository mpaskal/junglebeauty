    ...
    return (
      <div>
        <div className='page-background'>
          <h2>Price for kitten is 1200 - 2600 CAD.</h2>
          <h2>What price includes:</h2>
        ...
        <div className='page-background'>
          ...
          <p>
            ...
            This Kitten is not guaranteed against respiratory disease, fleas, ringworms or any nuisance disease, environmental stress (such as diarrhea etc.) and disease caused by dietary changes.
          </p><p>
            After the 72 hours period, the Seller can no longer guarantee the Kitten’s health, except for birth defects.
          </p>
        </div>
        <div className='page-background'>
