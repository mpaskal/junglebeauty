      ...
      <div className='page-background'>
        ...
        <ol className='list-container'>
          <li>
            ...
            Please arrange an online meeting where you can see those kittens you are interested in within 15-20 minutes and discuss possible questions.
          </li><li>
            ...
            During a personal meeting, you can communicate with the kitten and play if they have received two standard sets of vaccinations. The session lasts 30-40 minutes.
          </li><li>
            If you dislike the selected kitten, you can replace them with another one or refuse to purchase them and get back the entire deposit amount.
          </li><li>
